...
class UserProfileForm(forms.ModelForm):
    ...
    def save(self, commit=True):
        ...
        instance.is_preferred_display_name = (
            cleaned_data.get('is_preferred_display_name', False)
        )
        ...
        instance.is_profile_picture = cleaned_data.get('is_profile_picture',
                                                       False)
        instance.is_about_me = cleaned_data.get('is_about_me', False)
        instance.is_rank = cleaned_data.get('is_rank', False)
        instance.is_branch_of_military_served = cleaned_data.get(
            'is_branch_of_military_served', False
        )
        instance.is_length_of_service = cleaned_data.get(
            'is_length_of_service', False
        )
        instance.is_past_deployments = cleaned_data.get('is_past_deployments',
                                                        False)
